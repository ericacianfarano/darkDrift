...
class RetinotopicMap():
    ...
    def plot(self):
        ...
        ax.set_xticks([])
        ax.set_yticks([])
        plt.savefig(fr'I:\retmap_figures\{animal_name}\overlay {animal_name}{day}{subfile}.png')
        plt.savefig(fr'I:\retmap_figures\{animal_name}\overlay {animal_name}{day}{subfile}.svg')
